...
데이터 수집 결과를 텔레그램으로 받아보려면 아래 가이드를 참고하세요.

👉 **[텔레그램 알림 설정 가이드 보러가기](TELEGRAM_SETUP.md)**

## ⏰ 윈도우 작업 스케줄러 설정 (자동 실행)

PC가 켜져 있을 때 자동으로 데이터를 수집하려면 작업 스케줄러에 등록하세요.

👉 **[작업 스케줄러 설정 가이드 보러가기](SCHEDULER_SETUP.md)**
